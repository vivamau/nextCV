    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
        <div className="flex items-center gap-4">
          <label htmlFor="score-filter" className="text-[11px] font-bold text-gray-500 uppercase tracking-wider">
            Filter by Score:
          </label>
          <select
            id="score-filter"
            ...
            className="text-xs bg-gray-50 border border-gray-200 rounded-md px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all font-medium text-gray-700 cursor-pointer"
          >
        ...
        {filterType === 'above_average' && (
          <div className="flex items-center gap-2 px-3 py-1 bg-green-50 text-green-700 rounded-full border border-green-100 animate-in fade-in slide-in-from-right-2">
      ...
      <div className="overflow-x-auto bg-white rounded-lg border border-gray-100 shadow-sm">
        ...
        <thead className="bg-gray-50 border-b border-gray-100">
          <tr>
            ...
            <th 
              className="px-4 py-3 text-center text-[10px] font-bold text-gray-400 border-b-2 border-transparent hover:border-gray-200 cursor-pointer uppercase tracking-wider group"
              ...
              <tr key={c.id} className="hover:bg-gray-50 group transition-colors">
                ...
                <td className="px-4 py-3 text-center">
                  {c.skills_match_score ? (
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border border-blue-100 bg-blue-50 text-blue-600">
                      {c.skills_match_score}
                    </span>
                ...
                <td className="px-4 py-3 text-center">
                  {semanticScore !== undefined ? (
                    <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                      normalizeSemantic(semanticScore) >= 70 ? 'bg-green-100 text-green-700'
                      : normalizeSemantic(semanticScore) >= 40 ? 'bg-yellow-100 text-yellow-700'
